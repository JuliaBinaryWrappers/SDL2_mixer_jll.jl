...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SDL2_mixer_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7e88e5ca-120e-58e7-9660-b2187fd466c0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SDL2_mixer", artifacts_toml) for e in artifacts["SDL2_mixer"]]
...
if best_platform === nothing
    @debug("Unable to load SDL2_mixer; unsupported platform $(triplet(platform_key_abi()))")
else
